...
import adeliaLogo from '../assets/adelia.png'; // Your logo image
import gradientVideo from '../assets/gradientVideo.mp4'; // Your gradient video

const Header = () => {
  return (
    <header className="relative h-[1024px] overflow-hidden flex flex-col justify-center items-start px-100 text-white"
            style={{
                background: 'linear-gradient(180deg, #08062D 0%, #3E3768 100%)',
